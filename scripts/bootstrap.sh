...
echo "5. Grab passwords from Proton pass and populate tests/.env.testthen login with both accounts to populate DB and set permission_level in DB to 2 for moderator."
