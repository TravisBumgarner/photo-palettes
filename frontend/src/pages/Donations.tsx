  ...
  return (
    <PageWrapper minHeight staticContent width="medium">
      ...
      <Typography variant="body1">
        The project currently costs ${monthlyCost}/month or ${yearlyCost}/year
        to run. Below is a breakdown. At this point the costs are manageable for
        me. I have seen projects like this fall apart because of costs. If you
        would like to support the project, you can do so by donating.
      </Typography>
