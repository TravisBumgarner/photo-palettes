...
const Privacy = () => {
  return (
    <PageWrapper width="full" staticContent>
      ...
      <Typography variant="body1">
        Thank you for using our app. Your privacy is important to us, and we are
        committed to protecting your personal information. This Privacy Policy
        explains how we collect, use, and protect data in connection with our
        closed alpha app.
      </Typography>
      ...
      <Typography variant="body1">
        ...
        provided by Google LLC. Google Analytics uses cookies and similar
        technologies to collect and analyze information about your use of the
        app. Google may also use the collected data to contextualize and
        personalize ads on its own advertising network, though we do not enable
      ...
      <Typography variant="body1">
        We retain usage data for as long as necessary to analyze app performance
        and make improvements, or as required by our data processors (e.g.,
        Google Analytics, Sentry.io).
      </Typography>

      <Typography variant="h3">5. Security</Typography>
      <Typography variant="body1">
        We take reasonable steps to protect your information, but please note
        that no system can be guaranteed 100% secure. Since this is an
        early-stage testing phase, we recommend not sharing sensitive
      ...
      <Typography variant="body1">
        ...
        significant changes, we’ll notify testers through the app or via email.
      </Typography>
