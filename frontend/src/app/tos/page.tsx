...
const TermsOfService = () => {
  return (
    <StaticContentWrapper>
      ...
      <Typography variant="h2">1. Use of the Service</Typography>
      <Typography variant="body1">
      ...
      <Typography variant="h2">2. User Content & Sharing</Typography>
      <Typography variant="body1">
      ...
      <Typography variant="h2">6. Disclaimer</Typography>
      <Typography variant="body1">
      ...
      <Typography variant="h2">8. Changes</Typography>
      <Typography variant="body1">
