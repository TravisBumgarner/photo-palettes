...
const TermsOfService = () => {
  return (
    <PageWrapper width="medium" staticContent>
      ...
      <Typography variant="body1">
        You may use Photo Palettes to upload photos and generate color palettes for personal or
      ...
      <Typography variant="body1">
        You retain all rights to the photos you upload. By uploading content, you grant us a
      ...
      <Typography variant="body1">
        ...
        users, who can like, share, or comment on it. Public photos and their associated palettes
